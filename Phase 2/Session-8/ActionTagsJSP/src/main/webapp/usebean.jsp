...
<body>
	<h3>UseBean Demo</h3>
	<jsp:useBean id="object" class="com.using_bean.Student" scope="session"></jsp:useBean>
	<h4>Before setting property</h4>
	Id:
	<jsp:getProperty property="id" name="object" /><br> Name:
	<jsp:getProperty property="name" name="object" /><br>
